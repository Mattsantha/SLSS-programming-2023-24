...
search_name = "Matthew Lopez"

for name in names: 
    # Check to see if its the name we want
    if name == search_name:
...
# Print out Mr. Ubial is pretty cool
...
for i in range(10):
     print(f"{i + 1}. The wuick brown fox...")

# For example: we can start at another number
for i in range(1, 100):
     print(i)

# can we count by another number?
for i in range(0, 101, 2):
     print(i)

#1. Print all even numebrs between 1200 and 1500 inclusive. 
# Use a loop.
